...
csv_files = {
    'Em Alta': "./data/videos_populares.csv",
    'Música': "./data/videos_musica.csv",
    'Esportes': "./data/videos_esportes.csv",
    'Famosos': "./data/videos_famosos.csv",
    'Filmes': "./data/videos_filmes.csv"
}
...
server = MainApplication().app.server
